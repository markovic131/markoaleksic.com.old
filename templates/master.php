    ...
    <div id="wrap">
        ...
        <div class="page" id="education">
            ...
            <div class="page_content">
                <div class="row-fluid">
                    <div class="span10">
                        <p>
                            <strong>American College of Thessaloniki</strong> - <em>Thessaloniki, Greece</em> <br>
                ...
                <div class="row-fluid">
                    <div class="span10">
                        <p>
                            <strong>Norman North High School</strong> - <em>Norman OK, United States</em> <br>
        ...
        <div class="page" id="experience">
            ...
            <div class="page_content">
                <div class="row-fluid">
                    <div class="span8">
                        <p>
                            <strong>Seavus Corp.,</strong> Skopje, Macedonia
                        </p>
                        <p>Developer</p>
                        <ul>
                ...
                <div class="row-fluid">
                    <div class="span8">
                        <p>
                            <strong>Fortis Ltd.,</strong> Kumanovo, Macedonia
                        </p>
        ...
        <div class="page" id="projects">
            ...
            <div class="page_content">
                ...
                <h3>Fortis Ltd. - fortis.mk</h3>
                <p>Corporate dynamic website built on Carnia PMS</p>
                <p class="muted"><strong>Technlology:</strong> Carnia PMS</p>
                <h3>Gradska Pekara - gradskapekara.mk</h3>
                <p>Corporate dynamic website built on Carnia PMS</p>
                <p class="muted"><strong>Technlology:</strong> Carnia PMS</p>
                <h3>Kumanovski Kori - kumanovskikori.mk</h3>
                <p>Corporate dynamic website built on Carnia PMS</p>
                <p class="muted"><strong>Technlology:</strong> Carnia PMS</p>
            </div>
        </div>
